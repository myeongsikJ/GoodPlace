...
<link href="resources/css/idfind.css" rel="stylesheet" id="bootstrap-css">
<!DOCTYPE html>
<html lang="ko">
<head>
<meta charset="utf-8">
...
<body cellpadding="0" cellspacing="0" marginleft="0" margintop="0"
	...
	<div class="card align-middle" style="width: 25rem;">
		<div class="card-title" style="margin-top: 30px;">
			...
			<h2 class="card-title" style="color: white;">비밀번호 찾기</h2>
		</div>
	...
	<div class="links" style="color: white;">
		<div style="color: white;">
			<a class="a" href="login2">로그인</a> | <a class="a" href="idfind">아이디 찾기</a> | <a class="a" href="register">회원가입</a>
		</div>
	</div>
	</div>
